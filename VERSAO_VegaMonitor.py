...
from PyQt4.QtGui import QAction, QIcon, QPushButton, QApplication, QFileDialog
# Initialize Qt resources from file resources.py
import resources
# Import the code for the dialog
from VERSAO_VegaMonitor_dialog import VERSAOVegaMonitorDialog
import os
import os.path

from class_pretraitement import Pretraitement,detection_phenologique,CalculIndicateur

class VERSAOVegaMonitor:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'VERSAOVegaMonitor_{}.qm'.format(locale))
        ...
        self.dlg = VERSAOVegaMonitorDialog()

        # Declare instance attributes
        self.actions = []
        self.menu = self.tr(u'&VERSAO VegaMonitor')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'VERSAOVegaMonitor')
        self.toolbar.setObjectName(u'VERSAOVegaMonitor')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('VERSAOVegaMonitor', message)
...
#%%
    ...
    def initGui(self):
        ...
        self.add_action(
            icon_path,
            text=self.tr(u'Pre-processing, Phenology detection, Vegetative drought indices'),
